...
export function pickTarget(mobs, player, { minLevelDelta = -Infinity, maxLevelDelta = 3, prefer = 'closest' } = {}) {
  ...
  if (prefer === 'equal') {
    return eligible.slice().sort((a, b) => {
      ...
      return ad - bd || dist(a.cell, player.cell) - dist(b.cell, player.cell);
    })[0];
  }
  // 'weakest' fallback
